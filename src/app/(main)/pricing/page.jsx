      ...
      <div className="relative z-10 max-w-7xl mx-auto space-y-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          {pricingTiers.map((tier, idx) => (
            <div
              key={idx}
              className={`relative flex flex-col justify-between bg-[#0b0826]/60 backdrop-blur-2xl rounded-[32px] p-6 md:p-8 border transition-all duration-300 shadow-xl ${
                tier.isPopular
            ...
            >
              ...
              <div>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-slate-400 text-xs font-medium leading-relaxed min-h-[36px]">
                    {tier.description}
                  </p>
                </div>
                ...
                <div className="space-y-4 mb-8">
                  <h4 className="text-slate-500 text-[10px] uppercase tracking-widest font-black">
                    What's Included
                  </h4>
                  <ul className="space-y-3">
                    {tier.features.map((feature, fIdx) => (
                      <li key={fIdx} className="flex gap-3 items-start">
                        ...
                        <p className="text-slate-300 text-xs sm:text-sm font-medium leading-tight">
                          {feature}
                        </p>
                      </li>
                    ))}
              ...
              <button
                className={`w-full py-4 rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-200 cursor-pointer active:scale-[0.99] select-none ${
                  tier.isPopular
                    ...
                    : "border border-white/5 bg-[#06041a]/60 hover:bg-white/5 text-slate-300"
                }`}
              >
                {tier.buttonText}
              </button>
        ...
        {/* =========================================================
            ...
            ========================================================= */}
        <div className="border-t border-white/5 pt-16 max-w-4xl mx-auto space-y-12">
          <div className="text-center space-y-2">
            <h2 className="text-2xl font-black tracking-tight text-white flex items-center justify-center gap-2 uppercase tracking-wide text-sm">
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
            {faqs.map((faq, idx) => (
              <div
                key={idx}
                className="bg-[#0b0826]/40 border border-white/5 p-5 rounded-2xl space-y-2"
              >
                <h4 className="font-bold text-slate-200 text-xs sm:text-sm tracking-tight leading-snug">
                  {faq.question}
                </h4>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-12 pt-6 border-t border-white/5 text-slate-600 text-[11px] font-black uppercase tracking-widest">
