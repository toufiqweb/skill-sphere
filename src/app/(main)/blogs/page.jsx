    ...
    <div className="relative min-h-screen bg-[#05041a] py-12 pt-28 lg:pt-36 px-4 transition-colors duration-300 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 space-y-12 max-w-7xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-5">
          ...
          <h2 className="text-3xl font-black text-white sm:text-4xl lg:text-6xl tracking-tight leading-none">
            Ecosystem Insights &
        ...
        {/* =========================================================
            ...
            ========================================================= */}
        <div className="bg-[#0b0826]/40 border border-white/5 rounded-2xl p-3 flex flex-col md:flex-row items-center gap-4 text-xs max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2 md:gap-6 justify-center md:justify-start font-medium text-slate-400">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-[#0b0826]/60 backdrop-blur-2xl rounded-3xl p-6 border border-white/5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-center">
                <div className="p-3 bg-[#06041a]/40 border border-white/5 rounded-xl">
                  <p className="text-lg font-black text-white tracking-tight">1,240+</p>
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-500 mt-0.5 flex items-center justify-center gap-1">
                    <Award className="w-2.5 h-2.5 text-purple-400" /> Code Snippets
                  </p>
                </div>
                <div className="p-3 bg-[#06041a]/40 border border-white/5 rounded-xl">
                  <p className="text-lg font-black text-white tracking-tight">142</p>
                  <p className="text-[9px] font-bold uppercase tracking-wider text-slate-500 mt-0.5 flex items-center justify-center gap-1">
